...
class RobotActuator:
    def __init__(self):
        ...
        self.class_sub = rospy.Subscriber("/predicted_class", String, self.class_callback, queue_size=10)
    ...
    def class_callback(self, msg):
        ...
        if class_name == "Stop":
            ...
            twist_msg.linear.x = 0.1
            twist_msg.angular.z = 0.3
        elif class_name == "Give_Way" and self.last_class is not class_name:
            twist_msg.linear.x = 0.0
            twist_msg.angular.z = 0.0
